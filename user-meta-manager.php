...
function umm_admin_menu(){
  ...
  if(function_exists('load_plugin_textdomain')) {
      load_plugin_textdomain('user-meta-manager', WP_PLUGIN_DIR.'/'.dirname(plugin_basename(__FILE__)).'/language/', dirname(plugin_basename(__FILE__)).'/language/');
 }
